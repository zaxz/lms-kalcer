...
@php
    $paths = [
        ...
        'kmk' => '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 8h10"/><path d="M7 12h7"/><path d="M7 16h5"/><circle cx="17" cy="16" r="1.5" fill="currentColor" stroke="none"/><path d="M3 8h18"/>',
